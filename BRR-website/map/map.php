<?php
require "initailPosition.php";?>
<!DOCTYPE HTML>

<html>
<head>
	<title>MEDACINS</title>
	<meta charset="utf-8" />
...
<body >
			...
			<script>
				...
				function initMap() {
					...
					marker = new google.maps.Marker({
						position: {lat: 59.6664126, lng: 16.5159226},
						map: map,
						title: "Station No.1"
					});
					marker = new google.maps.Marker({
						position: {lat: 59.6556966, lng: 16.4905913},
						map: map,
						title: "Station No.2"
					});
					marker = new google.maps.Marker({
						position: {lat: 59.6159601, lng: 16.5287491},
						map: map,
						title: "Station No.3"
					});
					marker = new google.maps.Marker({
...
function drawCircle(index1){
	...
	cityCircle = new google.maps.Circle({
		...
		fillOpacity: 0.8,
		map: map,
		center: {lat:RaceCoordinates[index1].lat , lng:RaceCoordinates[index1].lng },
		radius: 110,
					...
					$.ajax({
						...
						success: function (response) {
							...
							cityCircle = new google.maps.Circle({
								...
								fillOpacity: 0.8,
								map: map,
								center: {lat: RaceCoordinates[parseFloat(response)].lat,
									lng: RaceCoordinates[parseFloat(response)].lng},
								radius: 110,
